...
from m3cv.models.losses import dice_coef, bce_dice_loss
...
def get_unet(image_size, num_channels=1, lr=1e-5):   #have adjusted filter size numbers to account for image size of 256
    
    #assert image_size == 256
    
    inputs = Input((image_size, image_size, num_channels))    #third number is the number of channels - configured for single W/L
